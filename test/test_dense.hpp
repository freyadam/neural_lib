...
TEST(TestDense, Forward) {
    ...
    nl::Block in("in", 1, 1, 3);    
    nl::Dense d1("d1", "relu", &in, 1, 1, 2);
    nl::Block& out = *d1.outputs()["d1_out"]; 
    nl::Block& weight = *d1.inputs()["d1_w"]; 
    nl::Block& thr = *d1.inputs()["d1_thr"]; 
...
TEST(TestDense, InputOutput) {
    ...
    nl::Block& d1_out = *d1.outputs()["d1_out"];
    // nl::Block& d1_in = d1.inputs()["b"];
    nl::Block& d1_w = *d1.inputs()["d1_w"];
    nl::Block& d1_thr = *d1.inputs()["d1_thr"];
    ...
    nl::Block& d2_out = *d2.outputs()["d2_out"];
    // nl::Block& d2_in = d2.inputs()["d1_out"];
    nl::Block& d2_w = *d2.inputs()["d2_w"];
    nl::Block& d2_thr = *d2.inputs()["d2_thr"];
